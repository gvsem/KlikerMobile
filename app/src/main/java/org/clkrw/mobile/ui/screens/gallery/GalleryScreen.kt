    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(text = show.presentation.title, style = Typography.titleMedium)
                Text(text = "Slides: ${show.maxSlidesCount}", style = Typography.labelSmall)
            }
            val imageBytes = Base64.decode(show.presentation.thumbnailUrl.substringAfter(","), Base64.DEFAULT)
            ...
            Image(
                ...
                contentDescription = show.presentation.title,
